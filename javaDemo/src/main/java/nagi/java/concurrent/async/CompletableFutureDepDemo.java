...
public class CompletableFutureDepDemo {
    public static void main(String[] args) {
        ...
        CompletableFuture<Integer> whenComplete = integerCompletableFuture.whenComplete((result, exception) -> {
        ...
        // 依赖子任务的任务FIFO
        whenComplete.whenComplete((result, exception) -> {
        ...
        try {
            // 使main不可调度，如果main可调度且空闲，则会调度main执行子任务
            Thread.sleep(100);
