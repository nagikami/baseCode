package nagi.netty.codec;// Generated by the protocol buffer compiler.  DO NOT EDIT!
...
public final class StudentPOJO {
  ...
  public interface StudentOrBuilder extends
    ...
    /**
     * <pre>
     * Student类中有 一个属性名字为id,类型为int32(protobuf类型) 1表示属性序号,不是值
     * </pre>
     *
  ...
  /**
   * <pre>
   * 会在StudentPOJO外部类生成一个内部类 Student，他是真正发送的POJO对象
   * </pre>
   *
